    ...
    while True:
        ...
        if command == "note":
            if command_arg == "create":
                # Запрашуємо ввести текст нотатку
                ...
                while True:
                    ...
                    note_id = int(
                        input(">>>Введіть ID нотатки, до якої хочете додати тег:")
                    )
                ...
                while True:
                    ...
                    if user_choice == "info":
                        ...
                        tag_index = int(
                            input(
                                ">>>Введіть індекс тегу для редагування (з верху від 0):"
                            )
                        )
                        if not tag_index in range(
                            0, len(note_manager.data.data[note_id].tags)
                        ):
            ...
            if command_arg == "add":
                ...
                print(
                    "Ви впевнені, що хочете очистити список ВСІХ контактів? (yes/так)"
                )
                qst = input(">>>")
                if qst == "yes":
                ...
                while True:
                    ...
                    if record_id.isdigit():
                        while True:
                            print(
                                "Що хочете зробити? (delete_phone | add_phone | edit_birthday | delete_email | add_email )"
                            )
                            qst = input(">>>")
                            if qst == "delete_phone":
                                ...
                                while True:
                                    ...
                                    try:
                                        ...
                                        print(
                                            "Телефон має бути десятизначним та повністю із цифр"
                                        )
                                        continue
                                break
                                ...
                                while True:
                                    try:
                                        ...
                                        contact_manager.edit_birthday(
                                            record_id, new_birthday
                                        )
                                        break
                                    except BirthdayError:
                                        print(
                                            "Недійсний формат дня народження, треба YYYY-MM-DD"
                                        )
                                        continue
                            elif qst == "delete_email":
                                print(
                                    "Впишіть індекст імейлу, який хочете видалити (з верху від 0)"
                                )
                                while True:
                                    ind = input(">>>")
                                    if not ind.isdigit():
